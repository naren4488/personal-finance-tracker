...
export function FormDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={cn(
          "flex max-h-[min(calc(100dvh-1.25rem-env(safe-area-inset-bottom)),92dvh)] w-[calc(100%-1rem)] max-w-lg flex-col overflow-hidden rounded-2xl border border-border/90 bg-card p-0 duration-200 sm:max-h-[min(92dvh,calc(100dvh-2rem))]",
